...
class TranslationController extends Controller
{
    ...
    {
        return $this->render('FiveAdminBundle:Translation:grid.html.twig', array(
            'layout'    => 'FiveAdminBundle::layout.html.twig',//$this->container->getParameter('lexik_translation.base_layout'),
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('FiveAdminBundle:Translation:new.html.twig', array(
            'layout' => 'FiveAdminBundle::layout.html.twig',//$this->container->getParameter('lexik_translation.base_layout'),
