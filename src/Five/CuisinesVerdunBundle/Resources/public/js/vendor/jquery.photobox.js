...
(function($, doc, win){
    ...
    var Photobox, photoboxes = [], photobox, options, images=[], imageLinks, activeImage = -1, activeURL, lastActive, activeType, prevImage, nextImage, thumbsStripe, docElm, APControl,
        ...
        // DOM elements
        closeBtn, image, video, prevBtn, nextBtn, thumbsToggler, caption, captionText, pbLoader, autoplayBtn, thumbs, wrapper, social,
        ...
        overlay =   $('<div id="pbOverlay">').append(
                        ...
                        caption = $('<div id="pbCaption">').append(
                            ...
                            thumbs = $('<div>').addClass('pbDescription'),
                            thumbs = $('<div>').addClass('pbThumbs'),
                            social = $('<div>').addClass('pbSocial').append('<h5>'+ getGlobal('share_title') +'</h5><a href="//www.pinterest.com/pin/create/button/" data-pin-do="buttonBookmark"  data-pin-shape="round" data-pin-height="32" target="_blank" style="cursor:hand;cursor:pointer;">&nbsp;</a>')
                        )
                    );
    /*---------------------------------------------------------------
    ...
    */
    ...
    Photobox.prototype = {
        ...
        imageLinksFilter : function(obj){
            ...
            return [obj.filter(function(i){
                ...
                //caption.description = ( thumbImg.data('desc') || '');
                ...
                images.push( [link[0].href, caption.content, thumbImg.getAttribute('src'), caption.description] );
    ...
    function captionTextChange(){
        ...
        //caption.find('.pbDescription').html('<span>' + images[activeImage + '</span>');
    }
